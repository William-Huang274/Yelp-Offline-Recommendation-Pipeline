...
- `docs/v1_freeze_20260313.md`
- `data/output/_v1_freeze_20260313/v1_freeze_manifest.json`
- `docs/first_champion_closeout_20260313.md`
...
- `GL-14` was completed on `2026-03-13` with `docs/data_contract.md`
...
- current classification note:
  - `docs/repo_hygiene_inventory_20260313.md`
...
- `docs/labeling_manual_v1.md`
- `docs/labeling_manual_v1_1.md`
- `docs/stage09_stage10_three_step_report_20260220.md`
- `docs/stage10_calibration_plan.md`
- `docs/stage10_pretrain_audit_20260226.md`
- `docs/stage10_pretrain_audit_20260226_1.md`
- `docs/stage11_execution_plan_20260227.md`
- `docs/stage11_qlora_prerequisites.md`
...
2. Link the active runbook docs, especially:
   - `docs/go_live_readiness_20260312.md`
   - `docs/stage11_cloud_run_profile_20260309.md`
...
- result note:
  - `docs/stage09_reaudit_20260313.md`
...
- aligned ordering is now:
  ...
  - `PreScore@10`
- result note:
  - `docs/gl07_stage10_stage11_alignment_20260313.md`
...
- result note:
  - `docs/gl08_prod_pointers_20260313.md`
...
- result note:
  - `docs/gl09_path_unification_20260313.md`
...
5. Document all required env vars in one place:
   - suggested file: `docs/config_reference.md`
...
- result note:
  - `docs/gl10_smoke_tests_20260313.md`
...
- first report artifact generated:
  - `docs/release_readiness_report_internal_pilot_v1_champion_20260313.md`
...
- result note:
  - `docs/gl12_batch_runner_20260313.md`
...
- current monitor report:
  - `docs/release_monitor_report_internal_pilot_v1_champion_20260313.md`
- result note:
  - `docs/rollback_and_monitoring.md`
- validation run completed for:
...
- `docs/data_contract.md` now exists as the canonical artifact inventory
