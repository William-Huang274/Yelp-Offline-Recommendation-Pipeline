...
## Evidence Files
- Alpha grid summary: [alpha_grid_stage11_3_qwen35_summary.json](../../tmp/alpha_grid_stage11_3_qwen35_summary.json)
- Alpha grid table: [alpha_grid_stage11_3_qwen35.csv](../../tmp/alpha_grid_stage11_3_qwen35.csv)
- Token audit: [qwen35_stage11_token_audit_20260306.json](../../tmp/qwen35_stage11_token_audit_20260306.json)
- Label-source audit: [qwen35_stage11_label_source_audit_20260306.json](../../tmp/qwen35_stage11_label_source_audit_20260306.json)
- Rebalance audit: [qwen35_stage11_rebalance_audit_20260306.json](../../tmp/qwen35_stage11_rebalance_audit_20260306.json)
- Probability distribution audit: [qwen35_stage11_prob_distribution_20260306.json](../../tmp/qwen35_stage11_prob_distribution_20260306.json)

## Execution Scripts
- Step 1 build: [stage11_qwen35_step1_build.sh](../../tmp/stage11_qwen35_step1_build.sh)
- Step 2 pilot train: [stage11_qwen35_step2_pilot_train.sh](../../tmp/stage11_qwen35_step2_pilot_train.sh)
- Step 3 pilot eval: [stage11_qwen35_step3_pilot_eval.sh](../../tmp/stage11_qwen35_step3_pilot_eval.sh)
